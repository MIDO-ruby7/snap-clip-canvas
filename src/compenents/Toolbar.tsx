...
const Toolbar: React.FC<ToolbarProps> = ({ onAddText, onAddMosaic, onAddShape, onAddImage, onSave, onFontWeight, onAddLine, onAddArrow, onAddNumber }) => {
  const tools = [
    ...
    { content: '数字', onClick: onAddNumber, icon: <img src={number}  alt="Texture" /> },
  ];
